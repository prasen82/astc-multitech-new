                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                        ...
                        <tbody>
                             ...
                             function main_attendence_driver($month,$staff_id)
                            {
                                ...
                                $sql="SELECT DATE_FORMAT(`log_date`,'%Y-%m-%d') as cnt FROM  log_master  WHERE `route_no`<>'99' and DATE_FORMAT(`log_date`,'%Y-%m')='".$month."' and conductor_staff_id='".$staff_id."'  and attendance_status=1  GROUP BY DATE_FORMAT(`log_date`,'%Y-%m-%d')";
