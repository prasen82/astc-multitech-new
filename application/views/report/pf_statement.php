                    ...
                    <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="text-right">Employee's Share (PF)</th>   
                                <th class="text-right">Employer's Contribution (PF)</th>   
                                <th class="text-right">Total PF</th>                                 
                               
                                <th class="text-right">Employee's Share (ESIC)</th>   
                                <th class="text-right">Employer's Contribution (ESIC)</th>   
                           ...
                           $id=0;
                            foreach ($salary as $st) {                              
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?= $st['pf_ac_no'] ?></td>
                                    ...
                                    <td  style="text-align:right"><?= number_format($st['pf_deduction'],2) ?></td>                                      
                                    <td  style="text-align:right"><?= number_format($st['eployers_pf_contribution'],2) ?></td>                                      
                                    
                                 
                                    <td  style="text-align:right"><?= number_format(($st['pf_deduction']+$st['eployers_pf_contribution']),2) ?></td>                                      
...
<script>
    $(document).ready(function(){
                    ...
                    var txt="PF / ESIC Statement Of <?=($emp_type=='d'?" Drivers ":($emp_type=='c'?" Conductors ":" Staffs "))?> For The Month of "+format_date($("#month").val());
