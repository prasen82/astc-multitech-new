                                ...
                                <div class="d-flex flex-column bg-light p-3 rounded h-100">
                                    <div class="mb-1 mb-md-1 text-center">
                                        <!-- <a href="index.html" class="d-block auth-logo"> -->
                                            <img src="<?php echo base_url('../') ?>assets/images/logo1.png" alt="" height="8"> <span class="logo-txt"><?= PROJECT_NAME ?></span>
                                        <!-- </a> -->
                                    </div>
                                    <div class="auth-content my-auto">
                                        ...
                                        <form class="mt-4 pt-2" action="<?php echo base_url('login/processLogin') ?>" method="post">
                                            <div class="mb-3">
                                                ...
                                                <input autocomplete=”off”  type="text" class="form-control" id="username" name="username" placeholder="Enter phone no" value="<?=$mobile?>">
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group auth-pass-inputgroup">
                                                    <input autocomplete=”off” type="password" name="password" class="form-control" placeholder="Enter password" aria-label="Password" aria-describedby="password-addon" value="<?=$password?>">
                                                </div>
                                            </div>
                                            <div class="mb-3">
